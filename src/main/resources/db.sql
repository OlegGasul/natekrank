...
-- -----------------------------------------------------
-- Table `natekrank`.`tests_taken`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `natekrank`.`tests_taken` ;

CREATE TABLE IF NOT EXISTS `natekrank`.`tests_taken` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `task_id` INT NULL COMMENT '',
  `sender` VARCHAR(255) NULL COMMENT '',
  `test_key` VARCHAR(8) NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `natekrank`.`tests_taken_answers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `natekrank`.`tests_taken_answers` ;

CREATE TABLE IF NOT EXISTS `natekrank`.`tests_taken_answers` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `question_id` INT NULL COMMENT '',
  `test_taken_id` INT NULL COMMENT '',
  `selected_answer_id` INT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `idx_ticket_id_idx` (`test_taken_id` ASC)  COMMENT '',
  ...
  FOREIGN KEY (`test_taken_id`)
  REFERENCES `natekrank`.`tests_taken` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
INSERT INTO tests_taken(task_id, test_key, email, first_name, last_name, minutes_for_solving)
VALUES(1, '12345678', 'oleg.gasul@gmail.com', 'Oleg', 'Gasiul', 90);
