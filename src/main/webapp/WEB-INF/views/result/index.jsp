...
<div class="container">
    ...
    <p>
        We offer you to pass this Test. You will have only ${survey.minuntesForSolving} minutes.
        When you be ready please push button "Start test".
    </p>

    <input class="btn btn-primary" ng-href="?start" type="button" value="Start test">
</div>
<!-- /container -->
